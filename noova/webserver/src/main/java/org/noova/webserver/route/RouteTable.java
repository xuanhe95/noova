...
public class RouteTable implements Router {
    ...
    private final Map<String, org.noova.webserver.Route> routes = new HashMap<>();

    private final Map<String, org.noova.webserver.Route> dynamicRoutes = new HashMap<>();
    ...
    public void addRoute(HttpMethod method, String path, org.noova.webserver.Route route) {
