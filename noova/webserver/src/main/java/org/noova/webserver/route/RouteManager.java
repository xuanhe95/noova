...
public class RouteManager {
    ...
    public static void addRoute(HttpMethod method, String path, org.noova.webserver.Route route, Host host) {
    ...
    public static String getVirtualHostName(org.noova.webserver.Request req){
...
//    }
    ...
    private static org.noova.webserver.Route getRoute(org.noova.webserver.Request req, org.noova.webserver.Response res) {
    ...
    public static boolean checkAndRoute(org.noova.webserver.Request req, org.noova.webserver.Response res) {
        org.noova.webserver.Route route = getRoute(req, res);
        if (route == null) {
    ...
    private static void route(Request req, org.noova.webserver.Response res, org.noova.webserver.Route route) {
        ...
        try {
            ...
            res.header("Server", org.noova.webserver.Server.SERVER_NAME);
