...
public class DirectIndexerProcessed {

    private static final Logger log = Logger.getLogger(DirectIndexerProcessed.class);
    ...
    static {
        try {
            ...
            InputStream tokenStream = DirectIndexerProcessed.class.getResourceAsStream("/models/en-token.bin");
            InputStream posStream = DirectIndexerProcessed.class.getResourceAsStream("/models/en-pos-maxent.bin");
            InputStream dictStream = DirectIndexerProcessed.class.getResourceAsStream("/models/en-lemmatizer.dict.txt");
            ...
            try (InputStream is = DirectIndexerProcessed.class.getResourceAsStream("/models/stopwords-en.txt")) {
                if (is == null) {
            ...
            if (ENABLE_PARSE_ENTITY) {
                ...
                InputStream personModelStream = DirectIndexerProcessed.class.getResourceAsStream("/models/en-ner-person.bin");
                InputStream locationModelStream = DirectIndexerProcessed.class.getResourceAsStream("/models/en-ner-location.bin");
                InputStream organizationModelStream = DirectIndexerProcessed.class.getResourceAsStream("/models/en-ner-organization.bin");
