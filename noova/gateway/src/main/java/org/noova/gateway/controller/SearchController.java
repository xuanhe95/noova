...
//                result.put("icon", icon);
    ...
    private void searchByKeywordsV6(Request req, Response res) throws IOException {
        ...
        double pgrkWeight = (req.queryParams("pr") == null) ? 0.8 : Double.parseDouble(req.queryParams("pg"));
        double titleDespMatchWeight = (req.queryParams("tt") == null) ? 2 : Double.parseDouble(req.queryParams("tt"));
        double phraseMatchWeight = (req.queryParams("pm") == null) ? 10 : Double.parseDouble(req.queryParams("pm"));
