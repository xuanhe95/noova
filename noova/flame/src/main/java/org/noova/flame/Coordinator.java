...
class Coordinator extends org.noova.generic.Coordinator {
  ...
  public static KVSClient kvs;
    ...
    post("/submit", (request,response) -> {
      ...
      try {
        ...
        // If the job completes normally, the output() method of the FlameContextImpl object will have been called, and we can
        // return the output to the user. If the job never called output(), we'll return a message to that effect.
